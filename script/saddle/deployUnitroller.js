function printUsage() {
	console.log(`
	usage: npx saddle script unitroller:deploy
...
(async function () {
	...
	let contract = await saddle.deploy('Unitroller')
    ...
    await saddle.verify(etherscanApiKey, contract._address, 'Unitroller', [], 0);
